...
export class PullRequestsService {
    ...
    public pullRequestsGetPullRequestsByProject({
        ...
        searchCriteriaMaxTime,
        searchCriteriaMinTime,
        ...
        return this.httpRequest.request({
            ...
            query: {
                ...
                'searchCriteria.maxTime': searchCriteriaMaxTime,
                'searchCriteria.minTime': searchCriteriaMinTime,
                'searchCriteria.queryTimeRangeType': searchCriteriaQueryTimeRangeType,
