...
import { RefsFavoritesForProjectService } from './services/RefsFavoritesForProjectService';
...
export class gitApi {
    ...
    public readonly refsFavoritesForProject: RefsFavoritesForProjectService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.refsFavoritesForProject = new RefsFavoritesForProjectService(this.request);
