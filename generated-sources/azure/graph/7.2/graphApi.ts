...
import { ServicePrincipalsService } from './services/ServicePrincipalsService';
...
export class graphApi {
    ...
    public readonly servicePrincipals: ServicePrincipalsService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.servicePrincipals = new ServicePrincipalsService(this.request);
