...
/* tslint:disable */
/* eslint-disable */
import type { UpdateWorkItemField } from '../models/UpdateWorkItemField';
import type { WorkItemField } from '../models/WorkItemField';
...
export class FieldsService {
    ...
    /**
     * Create a new field.
     * @returns WorkItemField successful operation
     * @throws ApiError
     */
    public fieldsCreate({
        organization,
         ...
         */
        project: string,
    }): CancelablePromise<WorkItemField> {
    ...
    }): CancelablePromise<Array<WorkItemField>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/{organization}/{project}/_apis/wit/fields',
            path: {
