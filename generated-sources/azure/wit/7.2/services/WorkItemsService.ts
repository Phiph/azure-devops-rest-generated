...
import type { WorkItemDeleteBatch } from '../models/WorkItemDeleteBatch';
import type { WorkItemDeleteBatchRequest } from '../models/WorkItemDeleteBatchRequest';
...
export class WorkItemsService {
     ...
     * @returns WorkItemDeleteBatch successful operation
     * @throws ApiError
     */
    public workItemsDeleteWorkItems({
        organization,
        body,
        project,
    }: {
         ...
         */
        project: string,
    }): CancelablePromise<WorkItemDeleteBatch> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/{organization}/{project}/_apis/wit/workitemsdelete',
            path: {
                'organization': organization,
                'project': project,
            },
