...
import type { PagedUserEntitlementsList } from '../models/PagedUserEntitlementsList';
...
export class UserEntitlementsService {
     ...
     * @returns PagedUserEntitlementsList successful operation
     * @throws ApiError
     */
    public userEntitlementsSearchUserEntitlements({
         ...
         */
        orderBy?: string,
    }): CancelablePromise<PagedUserEntitlementsList> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/{organization}/_apis/userentitlements',
            path: {
