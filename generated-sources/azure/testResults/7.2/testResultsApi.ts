...
import { ExtensionfieldsService } from './services/ExtensionfieldsService';
...
export class testResultsApi {
    ...
    public readonly extensionfields: ExtensionfieldsService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.extensionfields = new ExtensionfieldsService(this.request);
