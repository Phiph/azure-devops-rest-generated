...
export class TestlogstoreendpointService {
     ...
     * @throws ApiError
     */
    public testlogstoreendpointGetTestLogStoreEndpointDetailsForBuildLog({
        organization,
        project,
        build,
        type,
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/{organization}/{project}/_apis/testresults/testlogstoreendpoint',
            path: {
                'organization': organization,
                'project': project,
            },
     ...
     * @throws ApiError
     */
    public testlogstoreendpointTestLogStoreEndpointDetailsForBuild({
        organization,
        project,
        buildId,
        testLogStoreOperationType,
